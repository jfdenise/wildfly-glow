...
Feature-packs that are not stable enough to be included in the set of known Galleon feature-packs can be registered in the "incubating" space. 
...
link:https://github.com/jfdenise/wildfly-galleon-feature-packs/tree/incubating-space-poc/spaces/incubating[this] directory).
