 ...
 * @author jdenise
 */
class ArtifactResolutionImpl implements ArtifactResolutionBuilder {

    private final MavenRepoManager defaultMavenRepoManager;
    private final List<RemoteRepository> remoteRepos;
    ArtifactResolutionImpl() {
        remoteRepos = MavenResolver.getRemoteRepositories();
        defaultMavenRepoManager = MavenResolver.newMavenResolver();
    }
    @Override
