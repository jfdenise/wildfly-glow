...
public class ExplodedArchiveTestCase {
    ...
    public void testEarWithExclusions() throws Exception {
        ...
        Arguments arguments = Arguments.scanBuilder().
                ...
                .build();
        ScanResults scanResults = GlowSession.scan(MavenResolver.newArtifactResolution(), arguments, GlowMessageWriter.DEFAULT);
    ...
    private String runScan(Path archive) throws Exception {
        ...
        try( ScanResults scanResults = GlowSession.scan(MavenResolver.newArtifactResolution(), arguments, GlowMessageWriter.DEFAULT)) {
